            ...
            bool newP)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    players.Sort((p1, p2) => p2.coins.CompareTo(p1.coins));

                   
                    Console.WriteLine("\n\t\t\t\tID▌\tRank\tName\t\t  Coins\t\tWeapon Strength");
                    ...
                    for (int i = 0; i < players.Count; i++)
                    {
                        ...
                        if (player.id < 10)
                        {
                            ...
                            Console.WriteLine("\t\t\t\t{0} ▌\t{1}\t{2}\t{3}\t\t{4}",
                                ...
                                player.coins.ToString().PadLeft(5),
                                player.weaponValue.ToString().PadLeft(3)
                    ...
                    Console.WriteLine("\n\nType 'delete:id' to delete a save file.\t\t\t\t\t\t Type 'create' to create a new Player");
